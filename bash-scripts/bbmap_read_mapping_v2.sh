...
#PBS -l select=1:ncpus=70:mem=250gb:scratch_local=150gb:os=debian9
#PBS -j oe
#PBS -N bbmap_Pconfusum2
#
...
SAMDIR="/storage/brno3-cerit/home/tskalicky/CUL13/mapping/samtools"
...
cp -av $GENOME $SAMDIR/*$APPENDIX3 $SCRATCHDIR
cd $SCRATCHDIR
...
do
	...
	samtools view -@ $THREADS -F 0x4 -b -u -T Pconfusum_genome_cleaned_final_NCBI_upload.fa $READS3 | samtools sort --output-fmt BAM --threads $THREADS - -o $NAME3".sorted"
