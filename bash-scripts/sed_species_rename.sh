...
#
cd $DATADIR
#prvne potreba upravit jmena pridanim znaku, ktere se nevyskytuji mezi beznymi ASCI znaky jako '>\[' a \]< a pak udelat nahradu (\w+[0-9]+\.[0-9]) [a-zA-Z0-9 |a-zA-Z0-9_|a-zA-Z0-9-]+ >\[ a vymenit za \1 
#pozor na Tvaginalis a genomy z TriTrypDB, maji uplne jiny syntax 
...
-e 's/>\[Escherichia coli str\. K12 substr\. MG1655\]</Ecoli/g' \
...
-e 's/>\[Naegleria gruberi strain NEGM\]</Ngrube/g' \
