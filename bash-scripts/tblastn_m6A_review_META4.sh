...
declare -a PROTLIST=("ALKBH5_2OG-FeII_Oxy_domain.fa" "FTO_C_terminus_domain.fa" "FTO_N_terminus_catalitic_domain.fa" "METTL16_AdoMet_MTases_domain.fa")
...
#mkdir -p $OUTPUT_DIR
rm -vr $SCRATCHDIR/blastDB/genomeDB
