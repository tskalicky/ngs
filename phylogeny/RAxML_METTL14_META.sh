...
cd $DATADIR
raxmlHPC-PTHREADS -f a -x 12345 -p 987654 -N 200 -d -m PROTGAMMALG -T 20 -s METTL14_OG0006342_ren_mafft_gb.fst -n METTL14_OG0006342_quick
